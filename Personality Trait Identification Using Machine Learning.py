...
class train_model:
    ...
    def train(self):
        data =pd.read_csv(r'C:\Users\devap\OneDrive\Desktop\training_dataset.csv')
        array = data.values
...
def OpenFile(b4):
    global loc;
    name = filedialog.askopenfilename(initialdir="C:/Users/devap/Downloads/Programming/tkinter/",
                            filetypes =(('All files', '*'),("PDF","*.pdf*"),("Document","*.docx*"),),
                           title = "Choose a file."
                           )
    try:
